        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    ...
                    strsql_autre_table_afficher = """SELECT ID_Personne, Nom, Prenom FROM T_Personne WHERE ID_Personne = %(value_id_genre)s"""

                    mc_afficher.execute(strsql_autre_table_afficher)
                else:
                    strsql_genres_afficher = """SELECT * FROM T_Personne"""
                    mc_afficher.execute(strsql_genres_afficher)
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO T_Personne (ID_Personne,Nom,Prenom) VALUES (NULL,%(value_intitule_genre)s) """
